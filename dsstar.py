...
def main():
    ...
    if 'OPENAI_API_KEY' in config_defaults:
        os.environ['OPENAI_API_KEY'] = config_defaults['OPENAI_API_KEY']
    if 'GEMINI_API_KEY' in config_defaults:
        os.environ['GEMINI_API_KEY'] = config_defaults['GEMINI_API_KEY']
